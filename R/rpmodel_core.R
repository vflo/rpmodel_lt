...
rpmodel_core <- function(
  ...
  out_optchi$chi <- ifelse(out_optchi$chi>1,1,out_optchi$chi) #Resolve numeric problem when chi is infinitesimally greater than 1.
  ...
  ftemp25_inst_vcmax  <- ftemp_inst_vcmax( tcleaf, tc, tcref = 25.0 )
  ...
  ftemp25_inst_jmax <- ftemp_inst_jmax( tcleaf, tc, tcref = 25.0 )
